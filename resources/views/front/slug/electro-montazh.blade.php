...
@section('slug-content')
    <section>
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col">asdsd</div>
                <div class="col">sdsdds</div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            ...
            @php
                $items = [
                    (object)['title' => 'КАЧЕСТВО И БЕЗОПАСНОСТЬ', 'text' => 'Монтажные работы выполняют специалисты компании ЛЕДАЛЕН с высокой квалификацией и необходимыми группами допуска по электробезопасности.', 'image' => '//via.placeholder.com/1080x1080'],
                    (object)['title' => 'ПРОФЕССИОНАЛЬНЫЙ МОНТАЖ', 'text' => 'Мы индивидуально подходим к каждому проекту, учитывая требования заказчика для обеспечения высокого качества и эффективности освещения на объектах.', 'image' => '//via.placeholder.com/1081x1081'],
                    (object)['title' => 'СЕРВИС И ГАРАНТИЯ', 'text' => 'Предоставляем гарантию на все проведенные работы 1 год, а на наше светотехническое оборудование – до 5-х лет с заменой светильника, если он вышел из строя.', 'image' => '//via.placeholder.com/1082x1082'],
                ]
            @endphp
            <what-we-introduce
                :items='@json($items)'
