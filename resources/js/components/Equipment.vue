    ...
    data:()=>({
        equip: [
            {id: 1, name: 'Алмазное бурение', uri: 'almaz', equip:[
                ...
                {id: 2, name: 'Сканер', content: 'Специальный сканер для обнаружения проводки, труб, профилей гипсокартона, пустот. Проверка перед началом бурения.' , image: '//via.placeholder.com/512x512'},
                {id: 3, name: 'Cистема отвода воды', content: 'Наша система подачи и отвода воды, в промышленных масштабах, значительно ускоряет работы и даже делает возможным бурение там, где нет подключения к водопроводу напрямую. Достаточно только несколько вёдер воды. А в случае работы в квартире, офисе, больнице и т.д. позволяет произвести работы без разбрызгивания воды и затопления, в помещениях с ремонтом без его порчи.' , image: '//via.placeholder.com/512x512'}
            ]},
            {id: 2, name: 'Штробление', uri: 'shtrob', equip: [
                {id: 1, name: 'Изготовление штроб', content: 'Изготовление штроб под электрику, сантехники и д.р. Шириной от 20мм до нужной, глубиной от 20мм до 60мм' , image: '//via.placeholder.com/512x512'},
                {id: 2, name: 'Отверстия', content: 'Отверстия для подразетников' , image: '//via.placeholder.com/512x512'},
                {id: 3, name: 'Резка проёмов', content: 'Увеличение проёмов в бетонных и кирпичных сооружениях.' , image: '//via.placeholder.com/512x512'},
            ]},
            {id: 3, name: 'Демонтажные работы', uri: 'demontazh', equip: [
                {id: 1, name: 'Демонтаж стяжки', content: 'Демонтаж стяжки, бетонных полов, асфальта.' , image: '//via.placeholder.com/512x512'},
                {id: 2, name: 'Демонтаж стен', content: 'Демонтаж стен и перегородок' , image: '//via.placeholder.com/512x512'},
                {id: 3, name: 'Демонтаж металоконструкций', content: 'Демонтаж металоконструкций' , image: '//via.placeholder.com/512x512'},
            ]}
        ],
        current: 1
    }),
